...
$rm_relationship_json = array(array('key' => '', 'value' => 'All'),
                          array('key' => 'provisional', 'value' => 'Provisional'),
                          array('key' => 'final', 'value' => 'Final'));
$rm_relationship_json = json_encode($rm_relationship_json);
// preparing JSON values which are getting used in JAVASCRIPT for creating dropdown options. ENDS
@endphp
@extends('../layout')
@section('title', 'ARN Wise BDM Mapping List')
@section('breadcrumb_heading', 'ARN Wise BDM Mapping List')
...
@section('custom_scripts')
    ...
    function export_csv_formatted_data(inputObj){
        ...
        formObj.attr({'action': baseurl + '/arnbdmmapping'});
        formObj.submit();
            ...
            switch(data_column){
                ...
                case 'rm_relationship':
                    ...
                    if(data_column == 'status'){
                        ...
                        dropdown_filter_options = JSON.parse(@json($rm_relationship_json));
                    }
                    else{
