...
if(isset($data_table_headings_partner_aum_unique_client) && is_array($data_table_headings_partner_aum_unique_client) && count($data_table_headings_partner_aum_unique_client) > 0){
    foreach($data_table_headings_partner_aum_unique_client as $key => $value){
...
@endphp
@extends('../layout')
@section('title', 'Partners with AUM but count of Unique Clients Mapped less than 5')
@section('breadcrumb_heading', 'Partners with AUM but count of Unique Clients Mapped less than 5')
    ...
    <script type="text/javascript">
        ...
        function load_project_focus_datatable(){
            ...
            meetinglog_datatable = $('#panel_meetinglog').DataTable({
                ...
                "scrollX": true,
                "ajax": {
                    "url": baseurl +"/report-of-partner-aum-unique-client",
                    "dataType": "json",
                    "type": "POST",
                    "data": function(d){
                        if(arn_number != null && typeof arn_number != 'undefined' && arn_number != ''){
        ...
        function export_csv_formatted_data(inputObj){
            ...
            formObj.attr({'action': baseurl + '/report-of-partner-aum-unique-client'});
            formObj.submit();
