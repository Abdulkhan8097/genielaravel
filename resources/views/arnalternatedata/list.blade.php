...
@endphp
@extends('../layout')
@section('title', 'ARN Wise Alternate Mobile & Email List')
@section('breadcrumb_heading', 'ARN Wise Alternate Mobile & Email List')
...
@section('custom_scripts')
    ...
    function export_csv_formatted_data(inputObj){
        ...
        formObj.attr({'action': baseurl + '/arnalternatedata'});
        formObj.submit();
