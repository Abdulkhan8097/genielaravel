...
@section('breadcrumb_heading', 'Roles List')
...
<div class="row mt-4">
    <div class="col-lg-12">
       <div class="mt-2">  
            <a class="btn btn-primary btn-small" href="{{URL::to('/roles/addedit')}}"><i class="icons plus-icon"></i>Add</a>
        </div>
    </div>
</div>
...
@section('custom_scripts')
    ...
    function export_csv_formatted_data(inputObj){
        ...
        formObj.attr({'action': baseurl + '/roles'});
        formObj.submit();
