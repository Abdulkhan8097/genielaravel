...
@endphp
@extends('../layout')
@section('title', 'ARN & AMC Wise Data List')
@section('breadcrumb_heading', 'ARN & AMC Wise Data List')
...
@section('custom_scripts')
    ...
    function export_csv_formatted_data(inputObj){
        ...
        formObj.attr({'action': baseurl + '/arnamcwisedata'});
        formObj.submit();
        ...
        $('#panel_table_sm thead tr:nth-child(1) th').each(function(idx){
            ...
            switch(data_column){
                ...
                case 'status':
                    ...
                    break;
                case 'action':
                case 'total_commission_expenses_paid':
                case 'gross_inflows':
                case 'net_inflows':
                case 'avg_aum_for_last_reported_year':
                case 'closing_aum_for_last_financial_year':
                case 'effective_yield':
                    txtSearchInput = '&nbsp;';
