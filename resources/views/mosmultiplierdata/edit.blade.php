...
<div class="row mt-4">
    <div class="col-lg-12">
        <div class="mt-2">
            <form id="frm_sms_vendors" class="" action="{{url('mos_multiplier_data_edit')}}" method="post" onsubmit="" autocomplete="off">       
            @csrf
                <div class="row">
                    <div class="col-lg-12">
                        <div class="row form-inline">
                            ...
                            <div class="col-lg-6 col-sm-auto">
                                <div class="form-group">
                                    ...
                                    <input type="text"  class="form-control" id="select_multiplier" name="select_multiplier" value="{{$data->multiplier_type??''}}">
                                    <!-- <p class="error">&nbsp;</p> -->
                            ...
                            <div class="col-lg-6 col-sm-auto">
                                <div class="form-group">
                                    ...
                                    <input type="text"  class="form-control" id="select_margin" name="select_margin" value="{{$data->margin_of_safety??''}}">
                                    @error('select_margin')
                                         <p class="error">{{$message}}</p>
                                    @enderror
                                </div><!--/.form-group-->
                            ...
                            <div class="col-lg-6 col-sm-auto">
                                <div class="form-group">
                                    ...
                                    <input type="text"  class="form-control" id="select_multipliervalue" name="select_multipliervalue" value="{{$data->multiplier_value??''}}">
