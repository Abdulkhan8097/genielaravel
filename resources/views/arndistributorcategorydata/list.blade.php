...
@endphp
@extends('../layout')
@section('title', 'ARN Wise Distributor Category Data List')
@section('breadcrumb_heading', 'ARN Wise Distributor Category Data List')
...
@section('custom_scripts')
    ...
    function export_csv_formatted_data(inputObj){
        ...
        formObj.attr({'action': baseurl + '/arndistributorcategorydata'});
        formObj.submit();
    ...
    $(document).ready(function() {
        ...
        data_table = $('#panel_table_sm').DataTable({
            ...
            "scrollX": true,
            "ajax": {
                "url": baseurl + "/arndistributorcategorydata",
                "type": "POST",
                "data": function(d){
                    d.load_datatable = 1;
                },
