...
@endphp
@extends('../layout')
@section('title', 'Add a meeting log')
@section('breadcrumb_heading', 'Meeting Log >> Create')
...
<div class="row">
  ...
  <div class="col-lg-12">
    <div class="mt-2">
      <form action="{{url('save_meeting_data')}}" method="post" onsubmit="return ValidateForm();">
        @csrf
        <div class="row">
          <div class="col-lg-12">
              ...
              <div class="col-md-4 col-sm-4">
                <div class="form-group">
                  ...
                  <select class="form-control" id="meeting_mode" name="meeting_mode">
                    ...
                    <option value="{{$key}}"{{(old('meeting_mode') == $key)?'selected':''}}>{{$value}}</option>
                    @endforeach
                  </select>
              ...
              <div class="col-md-4 col-sm-4">
                <div class="form-group">
                  ...
                  <select class="form-control" name="contact_person" id="contact_person">
                    <optgroup label="ARN">
                      <option value="{{$partner_data->arn_holders_name}}"{{(old('contact_person') == $partner_data->arn_holders_name)?'selected':''}}>{{$partner_data->arn_holders_name}}\{{$partner_data->arn_email}}\{{$partner_data->arn_telephone_o}}</option>
                    </optgroup>
            ...
            <div class="row form-line">
              <div class="col-md-4 col-sm-4">
                <div class="form-group">
                  ...
                  <input type="hidden" class="form-control" id="arn_name" name="arn_name" value="{{$partner_data->arn_holders_name}}"/>
                </div><!--/.form-group-->
              </div><!--/.col-->
              <div class="col-md-4 col-sm-4">
                <div class="form-group">
                  <label>Name:</label>
                  <input type="hidden" class="form-control" id="arn_mobile" name="arn_mobile" value="{{$partner_data->arn_telephone_r}}"/>
                </div><!--/.form-group-->
              </div><!--/.col-->
              <div class="col-md-4 col-sm-4">
                <div class="form-group">
                  <label>Name:</label>
                  <input type="hidden" class="form-control" id="arn_email" name="arn_email" value="{{$partner_data->arn_email}}"/>
                </div><!--/.form-group-->
              </div><!--/.col-->
            </div><!--/.row form-inline-->
          </div><!--/.col-lg-12-->
            ...
            <div class="row form-line">
              <div class="col-md-4 col-sm-4">
                <div class="form-group">
                  ...
                  <input type="text" class="form-control" id="contact_name" name="contact_name" minlength="3" value="{{old('contact_name', $partner_data->arn_holders_name)}}"/>
              ...
              <div class="col-md-4 col-sm-4">
                <div class="form-group">
                  ...
                  <input type="text" class="form-control" id="contact_mobile" maxlength="10" name="contact_mobile" value="{{old('contact_mobile', $partner_data->arn_telephone_r)}}"/>
              ...
              <div class="col-md-4 col-sm-4">
                <div class="form-group">
                  ...
                  <input type="text" class="form-control" id="contact_email" name="contact_email" value="{{old('contact_email', $partner_data->arn_email)}}"/>
            ...
            <div class="row form-inline">
              <div class="col-md-4 col-sm-4">
                <div class="form-group">
                  ...
                  <div class='input-group date'>
                    ...
                    @endphp
                    <input type='datetime-local' class="form-control" id='start_time' name="start_time" max="{{$endTime}}" value="{{old('start_time')}}" />
              ...
              <div class="col-md-4 col-sm-4">
                <div class="form-group">
                  ...
                  <div class='input-group date'>
                    <input type='datetime-local' class="form-control" id='end_time' name="end_time" max="{{$endTime}}" value="{{old('end_time')}}" />
                    <span class="error">{{ $errors->first('end_time') }}</span>
                  </div><!--/.input-group date-->
                </div><!--/.form-group-->
              </div><!--/.col-->
              <div class="col-md-4 col-sm-4 d-none" id="datewise">
                <div class="form-group">
                  <label >Meeting Remarks</label>
                  <textarea id="remarks" name="remarks"  class="form-control" placeholder="Remarks">{{old('remarks')}}</textarea>
                </div><!--/.form-group-->
              </div><!--/.col-->
            </div>
          </div>
...
<script>
	...
	$(document).ready(function() {
	  $('#end_time').on('change', function() {
		...
		var current = '@php echo date('Y-m-d'); @endphp';
		var endTimeValue = datetimeString.split("T")[0];
		console.log("End Time value:", endTimeValue);
		
		// Compare datetimeString with the current date
		if (endTimeValue <= current) {
