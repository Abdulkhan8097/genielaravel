...
use App\Models\ArnalternatedataModel;

class Arnalternatedata extends Controller
{
    protected $data_table_headings;
    public function __construct(){
        $this->middleware('auth');
        $this->data_table_headings = array('ARN' => array('label' => 'ARN'),
                                           'alternate_mobile_1' => array('label' => 'Phone 1'),
                                           'alternate_mobile_2' => array('label' => 'Phone 2'),
                                           'alternate_mobile_3' => array('label' => 'Phone 3'),
                                           'alternate_mobile_4' => array('label' => 'Phone 4'),
                                           'alternate_mobile_5' => array('label' => 'Phone 5'),
                                           'alternate_email_1' => array('label' => 'Email 1'),
                                           'alternate_email_2' => array('label' => 'Email 2'),
                                           'alternate_email_3' => array('label' => 'Email 3'),
                                           'alternate_email_4' => array('label' => 'Email 4'),
                                           'alternate_email_5' => array('label' => 'Email 5'),
     ...
     * Purpose: JIRA ID: SMF-37. Helps to show list of available ARN alternate mobile and email data
     * Created:
     * Modified:
     * Modified by:
     */
    public function index(Request $request)
    {
        ...
        if(count($request->all()) > 0){
            ...
            $partnersData = ArnalternatedataModel::getARNAlternateDataList($request->all());
            ...
            if($flag_export_data){
                ...
                exec('sh '. get_server_document_root(true) . '/vendor/shell_scripts/export_csv_data.sh -i"arn_alternate_details" "'. $where_conditions .'" "'. $order_by_clause .'"', $return_var, $exit_code);
            ...
            // Pass to view
            return view('arnalternatedata/list')->with($data);
        }
    }
}
