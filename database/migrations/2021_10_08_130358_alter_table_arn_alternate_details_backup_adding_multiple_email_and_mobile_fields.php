...
class AlterTableArnAlternateDetailsBackupAddingMultipleEmailAndMobileFields extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        // adding multiple mobile and email id fields in MySQL table: arn_alternate_details_backup
        Schema::table('arn_alternate_details_backup', function (Blueprint $table) {
    ...
    {
        // removing earlier added multiple mobile and email id fields in MySQL table: arn_alternate_details_backup
        Schema::table('arn_alternate_details_backup', function (Blueprint $table) {
