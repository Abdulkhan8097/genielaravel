...
class FolioInvestotrDetails extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    {
        DB::connection('invdb')
        ->statement("CREATE TABLE `folio_investor_detail` (
 ...
 PRIMARY KEY (`id`),
 KEY `folio_investor_detail_investor_id_index` (`investor_id`),
 KEY `folio_investor_detail_index` (`email`),
 KEY `folio_investor_detail_mobile_index` (`mobile`),
 KEY `folio_investor_detail_pan_index` (`pan`)
