    ...
    public function up()
    {
        ...
        if(!Schema::hasTable('esign_vendors_master')){
            ...
            $insert_data = array(
                array(
                    'name' => 'TRUECOPY',
                    'uat_domain_url' => 'https://qasamcomf.truecopy.in',
                    'uat_api_key' => '3M6JJAPBDX5ZVJYX',
                    'live_domain_url' => 'https://samcomf.truecopy.in',
                    'live_api_key' => 'ADEXG6WQ5H2TRBGM',
                    'callback_url_success' => '/account_opening/aadhar_response',
                    'callback_url_failure' => '/account_opening/aadhar_response',
                    'status' => 0
                ),
            );
            ...
            $insert_data = array(
                array(
                    'name' => 'KHOSLA',
                    'client_code' => 'SAMC6765',
                    'uat_domain_url' => 'https://sandbox.veri5digital.com',
                    'uat_api_key' => '6534gfrefge6de',
                    'live_domain_url' => 'https://prod.aadhaarbridge.com',
                    'live_api_key' => '6534gfrefge6de',
                    'callback_url_success' => '/account_opening/aadhar_response',
                    'callback_url_failure' => '/account_opening/aadhar_response',
                    'status' => 1)
            );
