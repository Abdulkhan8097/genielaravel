...
class CreateRateCardPartnerwiseNfo extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('rate_card_partnerwise_nfo', function (Blueprint $table) {
    ...
    {
        Schema::dropIfExists('rate_card_partnerwise_nfo');
    }
}
